...
//    private String email;
//
//    @Column(name = "status", columnDefinition = "VARCHAR(10)", nullable = false, length = 10)
//    @Enumerated(EnumType.STRING)
//    private Status status = Status.USER; // Значение по умолчанию
//
...
////	CONSTRAINT ch_status CHECK (status IN ('Admin', 'User', 'Visitor'))
////);
////
////CREATE UNIQUE INDEX IF NOT EXISTS idx_users_unique ON Users(email);